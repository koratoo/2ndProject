...
<%-- <input id ="btn" type="button" value="<" onclick="history.back()" style="margin-left : 400px; margin-top: 10px;"> --%>
    ...
    <div style="width: 600px;">
        ...
        <div  class="margin_cls" align="left" > <img id ="person" src="../img/person.png"> 도움이 필요해요! &nbsp; :&nbsp;
            <select name="charity" id="charity-select" onchange="changeImage()">
			  <option value="child">평온했던 새벽, 무서운 지진이 도시를 강타했습니다.</option>
			  <option value="firefighter">강릉 산불 피해로부터 아이들을 지켜 주세요.</option>
			  <option value="volunteer">아이들의 세계를 넓혀 주세요.</option>
			</select>
        </div>
        <p class="margin_cls"/>
        <div class="margin_cls"  align="left" >선물할 포인트
            <input class="margin_cls" id="input1" type="number" placeholder="100포인트 이상 입력해 주세요." style="width:600px;" step="1000">
        </div>
        
        <div class="margin_cls" align="left" style="width:800">메시지
            <input class="margin_cls" id="input1" type="text" placeholder="항상 응원합니다!" style="width:600px;">
        </div>
    </div>
    <br>
    <input class="btn" type="button" value="기부하기" onclick="charityfuntion()"> 
