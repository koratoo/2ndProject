...
<nav class="navbar navbar-expand-md bg-dark navbar-dark fixed-top shadow-lg">
	...
	<div class="collapse navbar-collapse" id="navMenu">
		<ul class="navbar-nav">
			<li class="nav-item">
				<a href="../pointApi/ChargePoint" class="nav-link">결제 창 화면</a>
			</li>
			<li class="nav-item">
				<a href="../pointApi/virtual_account" class="nav-link">가상계좌 결제</a>
			</li>
			<li class="nav-item">
				<a href="../MAIN/main" class="nav-link">팀프로젝트로 이동!</a>
			</li>
			<li class="nav-item">
