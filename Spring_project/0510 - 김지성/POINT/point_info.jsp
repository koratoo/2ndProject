...
h1{
	...
	<script>
		 $(document).ready(function() {
			...
			var currentMonth = 4; // April (0-based index)
...
<!-- 상단 header -->
    ...
    <center id="container">
	    ...
	    <img src="../img/advertise.png" alt="" />
	        ...
	        <p/>
	            <input id="btn2" type="button" value="전  체" onclick="location.href='./charge_list'">&nbsp;
		...
		<script type="text/javascript">
		  function savePDF(){
		    ...
		    html2canvas($('#pdfArea')[0] ,{	
		      ...
		      while (heightLeft >= 10) {			// 35
		      position = heightLeft - imgHeight;
		      position = position - 10 ;		// -25
