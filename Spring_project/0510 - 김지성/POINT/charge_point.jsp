...
<body>
	...
	<center id="container">
		...
		<div align="right" style="width: 800px;">
			<a class="pointinfo_img" href="./point_info"><img src="../img/point.png" title="포인트정보 페이지로 이동합니다."/></a>
		</div>
		<br>
		...
		<div class="click-money-btn">
			<button id="btn2"  value="1000" onclick="calc(this)" title="최대 100만원까지 가능합니다.">천원</button>
			<button id="btn2"  value="5000" onclick="calc(this)" title="최대 100만원까지 가능합니다.">5천원</button>
			<button id="btn2"  value="10000" onclick="calc(this)" title="최대 100만원까지 가능합니다.">만원</button>
			<button id="btn2"  value="100000" onclick="calc(this)" title="최대 100만원까지 가능합니다.">10만원</button>
			<button id="btn2"  onclick="init(this)"  title="최대 100만원까지 가능합니다.">직접입력하기</button>
		</div>
		<p /><br>
		...
		<input class="charge_btn" type="submit" onclick="requestPay()" value="충전하기(kakao pay)" style="width: 800px; height: 50px; font-size:30px;" title="금액입력, 아래의 merchant_id를 확인해주세요!">
				
			<br>	
			<h6>PLORS 판매 번호</h6>
			<h6>이미 성공한 판매번호는 다시 사용할 수 없습니다.</h6>
			<input id="merchant_id" type="text" value="57008833-33027" style="text-align:center" />
			<br><h6>made by js</h6>
